...
wget https://cran.uni-muenster.de/src/base/R-3/R-${R_VERSION}.tar.gz
sudo mkdir /opt/R/
...
# Install R packages
./bin/Rscript -e 'chooseCRANmirror(graphics=FALSE, ind=34); install.packages("jsonlite")' # We need JSON lite

# Add your R packages here
./bin/Rscript installDependencies.R
